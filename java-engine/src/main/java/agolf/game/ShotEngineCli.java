...
public class ShotEngineCli {
    ...
    public static void main(String[] args) throws Exception {
        Map<String, String> input = readInput();
        ...
        Seed seed = input.containsKey("seedRaw") ? Seed.fromRaw(longValue(input, "seedRaw", 0L)) : new Seed(longValue(input, "seed", 0L));
        ...
        shot.run();
        System.out.println(toJson(shot));
    }
